...
# ✅ NOUVEAUX CHAMPS - Horaires personnalisables
    ...
    def clean(self):
        ...
        # Validation cohérence matin/après-midi
        if self.type_demi_journee == 'MATIN' and self.heure_fin > time(13, 0):
            errors['heure_fin'] = "Une demi-journée 'Matin' ne peut pas se terminer après 13h."
        
        if self.type_demi_journee == 'APRES_MIDI' and self.heure_debut < time(12, 0):
            errors['heure_debut'] = "Une demi-journée 'Après-midi' ne peut pas commencer avant 12h."
